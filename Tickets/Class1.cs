...
//         string insertTicket = "Insert into allTickets (userName, expenseNote, cost, [date],[status]) values ('"+ start.login().userName +"','" + expenseNote + "','"+ cost +"', GetDate(),'Pending Approval')";
